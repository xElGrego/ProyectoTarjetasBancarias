...
namespace BackendTarjetas
{
...

    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BackendTarjetas", Version = "v1" });
            });
      ...
      //Para evitar el error al hacer la peticion htpp
      ...
      //Permite cualquier origen
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BackendTarjetas v1"));
            }
